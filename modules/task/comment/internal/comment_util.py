...
from modules.task.comment.types import Comment
...
class CommentUtil:
    ...
    def convert_comment_bson_to_comment(comment_bson: dict[str, Any]) -> Comment:
        ...
        return Comment(
            ...
            created_at=validated_comment_data.created_at.isoformat()
            if validated_comment_data.created_at
            else "",
            updated_at=validated_comment_data.updated_at.isoformat()
            if validated_comment_data.updated_at
            else "",
        )
